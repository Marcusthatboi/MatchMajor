...
const Survey = ({ setUser }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Validation
    if (!formData.sleepSchedule || !formData.cleanliness || !formData.items || !formData.pets || !formData.vistors || !formData.allergies || !formData.campusSelection || !formData.socialBattery ) {
      setError('Please fill in all required fields (Sleep Schedule, Cleanliness, Items, Pets, Visitors, Allergies, Campus Selection, Social Battery).');
      return;
    }
  ...
  return (
    <div className="survey2-page">
      <div className="survey2-container">
        ...
        <form onSubmit={handleSubmit} className="survey2-form">
